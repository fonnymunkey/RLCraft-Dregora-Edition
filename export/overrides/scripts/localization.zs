//Rustic seeds no longer need manual tooltip addition. Localizator fixes that		
...
//END Deprecate rustic seeds with localizator
...
<iceandfire:fishing_spear:*>.displayName = game.localize("item.iceandfire.fishing_spear.name","en_us");
...
<betternether:bone_block>.displayName = game.localize("tile.bone_block.name","en_us");

<bountifulbaubles:reforger>.displayName = game.localize("tile.bountifulbaubles.reforger.name","en_us");
